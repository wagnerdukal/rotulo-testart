...
function Edit3() {
  return (
    <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M17.5 2.5a2.121 2.121 0 013 3L12 14l-4 1 1-4 7.5-7.5z"/>
    </svg>
  );
}
function Trash() {
...
// Resolve iconName (string) → componente
function PermIcon({ name }) {
  if (name === 'Eye')         return <Eye />;
  if (name === 'CheckSquare') return <CheckSquare />;
  if (name === 'Edit3')       return <Edit3 />;
